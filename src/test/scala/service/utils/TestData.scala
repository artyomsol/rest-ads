 ...
 */
trait TestData {
  val oldCarAD = ADEntity(Some(10L), "Audi A4 Avant", diesel, 100, `new` = false, mileage = Some(100000), Some(DateTime.parse("2017-06-27T00:00:00.000Z")))
  ...
  val newCarAD = ADEntity(Some(10L), "Audi A4 Avant", diesel, 100, `new` = true)
